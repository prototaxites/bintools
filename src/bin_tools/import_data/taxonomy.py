...
def _read_taxonomy_file(
    file: Path, bin_name_column: str, classification_column: str, taxonomy_source: str
...
def add_taxonomy(
    bins: list[Bin], taxonomy_file: Path, taxonomy_source: str | None
) -> list[Bin]:
    """
